    ...
    <div class="projectBody searchAndSocialGeeks">
        ...
        ?></h1>
            ...
            <div class="heroImage completedImage">
                <img class="centerImage" src="../images/portfolio/portfolio-php.png" alt="">
            </div>
            ...
            <div class="subHeroImage completedImage">
                <img class="centerImage" src="../images/portfolio/portfolio-mobile-mockup.png" alt="">
            </div>
            ...
            ?>     
                ...
                <div class="minorCards">
                    <div class="galleryImage completedImage">
                        <img class="centerImage" src="../images/portfolio/porfolio-home-php.png" alt="">                        
                    </div>
                </div>
            </div>
            ...
            ?>
                <div class="minorCards">
                    <div class="galleryImage completedImage">
                        <img class="centerImage" src="../images/portfolio/backend-cms.png" alt="">
                    </div>
                </div>
            </div>
            ...
            ?>     
                <div class="minorCards">
                    <div class="galleryImage completedImage">
                        <img class="centerImage" src="../images/portfolio/portfolio-home.png" alt="">
                    </div>
                </div>
            </div>

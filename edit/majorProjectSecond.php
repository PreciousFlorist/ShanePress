        ...
        <div class="wrapper"> 
                ...
                <!-- Title -->
                    <div>
                        ...
                        <input type="text" name="secondProjectTitle" value="<?php 
                        ...
                        ?>">
                            ...
                            <textarea type="textarea" name="secondProjectIntroParagraph"><?php 
                    ...
                    <div class="panel">
                        ...
                        ?> </label>
                            ...
                            <div class="svgAlign">
                                <input type="text" class="svg" name="secondSVGOne" value="<?php 
                                ...
                                ?>"> <button class="svgDelete" name="deleteSecondSVGOne">Remove SVG</button>
                            </div>
                            ...
                            ?></label>
                            <div class="svgAlign">
                                <input type="text" class="svg" name="secondSVGTwo" value="<?php 
                                ...
                                ?>"> <button class="svgDelete" name="deleteSecondSVGTwo">Remove SVG</button>
                            </div>
                            ...
                            <div class="svgAlign">
                                <input type="text" class="svg" name="secondSVGThree" value="<?php 
                                ...
                                ?>"> <button class="svgDelete" name="deleteSecondSVGThree">Remove SVG</button>
                            </div>
                            ...
                            ?></label>
                            <div class="svgAlign">
                                <input type="text" class="svg" name="secondSVGFour" value="<?php 
                                ...
                                ?>"> <button class="svgDelete" id="deleteSecondSVGFour" class="deleteSecondSVGFour" name="deleteSecondSVGFour">Remove SVG</button>
                            </div>
                            ...
                            <div class="svgAlign">
                                <input type="text" class="svg" name="secondSVGFive" value="<?php 
                                ...
                                ?>"> <button class="svgDelete" name="deleteSecondSVGFive">Remove SVG</button>
                    ...
                    <div class="panel">
                            ...
                            <input type="text" name="secondSubHeadingOne" value="<?php 
                            ...
                            <textarea type="textarea" name="secondExcerptOne"><?php 
                            ...
                            <input type="text" name="secondSubHeadingTwo" value="<?php 
                            ...
                            <label for="aboutParagraph" class="formTitle">Excerpt:</label>
                            <textarea type="textarea" name="secondExcerptTwo"><?php 
                            ...
                            <input type="text" name="secondSubHeadingThree" value="<?php 
                            ...
                            <label for="aboutParagraph" class="formTitle">Excerpt:</label>
                            <textarea type="textarea" name="secondExcerptThree"><?php 
                            ...
                            <input type="text" name="secondSubHeadingFour" value="<?php 
                            ...
                            <label for="aboutParagraph" class="formTitle">Excerpt:</label>
                            <textarea type="textarea" name="secondExcerptFour" ><?php 

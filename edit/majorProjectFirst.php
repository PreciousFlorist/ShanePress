        ...
        <div class="wrapper"> 
                ...
                <!-- Title -->
                    <div>
                        ...
                        <input type="text" name="firstProjectTitle" value="<?php 
                        ...
                        ?>">
                            ...
                            <textarea type="textarea" name="firstProjectIntroParagraph"><?php 
                    ...
                    <div class="panel">
                        ...
                        ?> </label>
                            ...
                            <div class="svgAlign">
                                <input type="text" class="svg" name="firstSVGOne" value="<?php 
                                ...
                                ?>"> <button class="svgDelete" name="deleteFirstSVGOne">Remove SVG</button>
                            </div>
                            ...
                            ?></label>
                            <div class="svgAlign">
                                <input type="text" class="svg" name="firstSVGTwo" value="<?php 
                                ...
                                ?>"> <button class="svgDelete" name="deleteFirstSVGTwo">Remove SVG</button>
                            </div>
                            ...
                            <div class="svgAlign">
                                <input type="text" class="svg" name="firstSVGThree" value="<?php 
                                ...
                                ?>"> <button class="svgDelete" name="deleteFirstSVGThree">Remove SVG</button>
                            </div>
                            ...
                            ?></label>
                            <div class="svgAlign">
                                <input type="text" class="svg" name="firstSVGFour" value="<?php 
                                ...
                                ?>"> <button class="svgDelete" name="deleteFirstSVGFour">Remove SVG</button>
                            </div>
                            ...
                            <div class="svgAlign">
                                <input type="text" class="svg" name="firstSVGFive" value="<?php 
                                ...
                                ?>"> <button class="svgDelete" name="deleteFirstSVGFive">Remove SVG</button>
                    ...
                    <div class="panel">
                            ...
                            <input type="text" name="firstSubHeadingOne" value="<?php 
                            ...
                            <textarea type="textarea" name="firstExcerptOne"><?php 
                            ...
                            <input type="text" name="firstSubHeadingTwo" value="<?php 
                            ...
                            <label for="aboutParagraph" class="formTitle">Excerpt:</label>
                            <textarea type="textarea" name="firstExcerptTwo"><?php 
                            ...
                            <input type="text" name="firstSubHeadingThree" value="<?php 
                            ...
                            <label for="aboutParagraph" class="formTitle">Excerpt:</label>
                            <textarea type="textarea" name="firstExcerptThree"><?php 
                            ...
                            <input type="text" name="firstSubHeadingFour" value="<?php 
                            ...
                            <label for="aboutParagraph" class="formTitle">Excerpt:</label>
                            <textarea type="textarea" name="firstExcerptFour" ><?php 
